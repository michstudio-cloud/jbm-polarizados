        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-24">
                ...
                <div className="bg-gray-50 dark:bg-zinc-900/50 rounded-2xl p-6 border border-gray-200 dark:border-zinc-800 mb-8">
                    <div className="flex items-end gap-3 mb-2">
                        <span className="text-6xl font-black text-gray-900 dark:text-white leading-none">4.9</span>
                        <div className="mb-2">
            ...
            <div className="lg:col-span-8 grid md:grid-cols-2 gap-6">
                {reviews.map((review, idx) => (
                    <div 
                        key={idx} 
                        className="bg-white dark:bg-zinc-900 p-8 rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-sm hover:shadow-xl hover:shadow-orange-500/5 hover:-translate-y-1 transition-all duration-300"
                    >
                        ...
                        <div className="pt-4 border-t border-gray-50 dark:border-zinc-800/50 flex justify-between items-center">
